...
`ex_people` contains 100 patients (with random names from the [`randomNames`](https://centerforassessment.github.io/randomNames/) package) who received THA surgery at given (random) dates (`surgery` column). This data might represent a sample from a national quality register.
